...
import {deleteStoredText as deleteStoredTextAction} from '../../actions';
...
const mapStateToProps = (state: RootState) => {
  return {storedText: state.text.stored};
};

export default connect(mapStateToProps, {
  deleteStoredText: deleteStoredTextAction,
})(UseStoredText);
